...
const MENU_ITEMS: MenuItem[] = [
  {
    id: '1',
    name: 'Wagyu & Void',
    description: 'A poetic interaction of smoked A5 Wagyu tartare, black garlic emulsion, and charcoal-infused cracker. Served in absolute silence.',
    price: '42',
    category: 'starter',
  ...
  },
  {
    ...
    description: 'Carnaroli rice stained with cuttlefish ink, topped with Hokkaido scallops and a dusting of edible gold leaf to break the darkness.',
    price: '55',
    category: 'main',
  ...
  },
  {
    ...
    description: '70% Dark Chocolate ganache encased in a truffle shell, sea salt crystals, and a whisper of truffle oil.',
    price: '28',
    category: 'dessert',
